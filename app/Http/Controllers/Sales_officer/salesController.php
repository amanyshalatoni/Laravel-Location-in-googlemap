...
class salesController extends BaseController
{
    public function index(Request $request)
    {
        ...
        $items=sales_officer::whereRaw("isdelete=0");
        ...
        return view("admin.sales_officer.index",compact("items","q","active","gender"));
    }
	
    public function show($id)
    {
        $item=sales_officer::find($id);
        if($item==NULL)
            return redirect("/admin/sales_officer");
        return view("admin.sales_officer.show",compact("item"));
    }
