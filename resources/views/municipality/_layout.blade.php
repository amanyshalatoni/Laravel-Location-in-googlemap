...
<html lang="en" dir="rtl">
    ...
    <head>
        <meta charset="utf-8" />
        <title> البلدية  | @yield("title")</title>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> //هنا </span>
                                <i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="/municipality/home/changepassword">
                                        <i class="icon-user"></i> تغيير كلمة المرور </a>
                                </li>
                                <li>
                                    <a href="/municipality/home/profile">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start ">
                            <a href="/municipality/plate" class="nav-link nav-toggle">
                                <i class="icon-list"></i>
                                <span class="title">اللوحات  </span>
                            </a>
                        </li>
                        <li class="nav-item start ">
                            <a href="/municipality/plate/create" class="nav-link nav-toggle">
                                <i class="icon-plus"></i>
                                <span class="title">اضافة لوحة جديدة  </span>
                            </a>
                        </li>
