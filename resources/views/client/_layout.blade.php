                    ...
                    <ul class="nav navbar-nav pull-right">
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                <li>
                                    <a href="/client/home/changepassword">
                                        <i class="icon-user"></i> تغيير كلمة المرور </a>
                                </li>
                                <li>
                                    <a href="/client/home/profile">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start ">
                            <a href="/client/plate" class="nav-link nav-toggle">
                                <i class="icon-list"></i>
                                <span class="title">حجز لوحة   </span>
                            </a>
                        </li>
                        <li class="nav-item start ">
                            <a href="/client/client" class="nav-link nav-toggle">
                                <i class="icon-plus"></i>
                                <span class="title">السلة الشرائية  </span>
                            </a>
                        </li>
