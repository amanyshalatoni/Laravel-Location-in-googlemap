                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">اللوحات</span>
                                <span class="arrow"></span>
                            </a>
                           <ul class="sub-menu">
                                <li class="nav-item start ">
                                    <a href="/admin/plate" class="nav-link ">
                                        <i class="icon-bar-chart"></i>
                                        <span class="title"> اللوحات</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item start ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start ">
                                    <a href="/admin/municipality" class="nav-link ">
                                        <i class="icon-bar-chart"></i>
                                        <span class="title">البلديات</span>
                                    </a>
                                </li>
                                <li class="nav-item start ">
                                  ...
                                  <li class="nav-item start ">
                                    <a href="/admin/sales" class="nav-link ">
                                        <i class="icon-bulb"></i>
                                        <span class="title">موظف المبيعات</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
      ...
      <div class="modal-dialog" role="document">
        ...
        <script>
          ...
          toastr.options = {
           ...
           function ShowMessage(msg,title="Admins"){			
               var color="info";
          ...
          $(function(){
              ...
              //to deleeeete
                    ...
                    $("#Confirm .btn-danger").click(function(e) {
                        $.ajax({
                            ...
                            dataType: "JSON",
                            error:function(){                                
                                ShowMessage("e: لا يمكن الحذف ","لوحة التحكم");		
                            }
                        });
                        $("#Confirm").modal("hide");
                        return false;
            ...
            //ب create ,edit حطيت فوق ajaxform معناتو قبل ما تبعتو وقف الزر ولما ينجح خليه يشتغل ويظهر خطا
          function PageLoadMethods(){
              $(".ajaxForm").ajaxForm({
				success:function(json) { 	
					...
					if(json.status==1){
						$('.ajaxForm').resetForm();
                        // عشان يعمل ريفريش للجديد حطيت الكومنت
				...
				//		}
						...
						ShowMessage(json.msg,"error","ادارة المستخدمين");				
					}
