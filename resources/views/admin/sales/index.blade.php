...
<table class="table table-striped table-hover">
    <thead>
        <tr><th>اسم موظف المبيعات</th><th>البريد الالكتروني</th><th>رقم الجوال</th><th>نوع الجنس</th><th width="15%">تاريخ الانشاء</th><th width="5%">فعال؟</th>
            <th width="15%"></th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>
				 <a href="/admin/sales/{{$i->id}}" class="btn btn-info btn-xs">
                    <i class="glyphicon glyphicon-info-sign"></i>
                </a>
                    <a href="/admin/sales/{{$i->id}}/delete" class="Confirm btn btn-danger btn-xs">
...
<script>
    $(function(){
        $(".cbActive").click(function(){
            var id=$(this).val();
            $.get("/admin/sales/active/"+id,function(json){
                ShowMessage(json.msg,"ادارة موظفي المبيعات");
            },"json");
        });
    });
</script>
